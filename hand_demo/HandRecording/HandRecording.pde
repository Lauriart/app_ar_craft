 ...
 * Creates a series of screenshots of leap motion hand positions 
 *
 * Adapted from the Leap Motion LM_1_Basic Example 
 */
...
void draw() {
  ...
  for (Hand hand : leap.getHands ()) {
    ...
    // Drawing
    hand.draw();
    //HandNoText h = new HandNoText();
    //h.draw(hand);
    //hand.drawFingers();
    //byte[] serializedFrame = hand.serialize();
...
//    }
  ...
  saveFrame("hand_images/screen-" + nf(image_counter, 4) + ".tif");
  image_counter++;
}
